                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nif" type="number" class="form-control @error('nif') is-invalid @enderror" name="nif" value="{{ old('nif') }}">
                        ...
                        <div class="row mb-3">
                            <label for="default_payment_type" class="col-md-4 col-form-label text-md-end">{{ __('Default-Payment-Type') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="default_payment_ref" class="col-md-4 col-form-label text-md-end">{{ __('Default-Payment-Ref') }}</label>

                            <div class="col-md-6">
                            <input id="default_payment_ref" type="text" class="form-control @error('default_payment_ref') is-invalid @enderror" name="default_payment_ref" value="{{ old('default_payment_ref') }}">
